...
def get_bot_id(botname=''):
	...
	"""
	if environ.get('rocketbmbot'):
		botname = environ.get('rocketbmbot')
	else:
...
def get_slack_token():
	...
	"""
	if environ.get('xoxb-461156293569-1074423723031-Qhy29451xvjwI94QLvPCSbLz'):
		return environ.get('xoxb-461156293569-1074423723031-Qhy29451xvjwI94QLvPCSbLz')
	else:
